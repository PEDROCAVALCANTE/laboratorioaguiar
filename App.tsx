...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (auth === 'authenticated') {
      ...
      // Mostra o modal de assinatura após um pequeno delay para efeito visual
          ...
          <div className="bg-white rounded-[32px] shadow-2xl max-w-sm w-full overflow-hidden border border-white/20 animate-in zoom-in-95 duration-500">
            <div className="relative p-8 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight mb-3">
                Regularize sua <br /> Assinatura
              </h3>
              
              <p className="text-[13px] text-slate-500 font-medium leading-relaxed mb-8 px-2">
                Olá! Para garantir que o seu laboratório continue operando com 100% de eficiência e segurança, pedimos a gentileza de regularizar sua assinatura mensal.
              </p>
              ...
              <div className="w-full space-y-3">
                ...
                >
                  Regularizar Agora <CheckCircle2 size={16} />
                </button>
                <button 
                  onClick={() => setShowSubscriptionModal(false)}
